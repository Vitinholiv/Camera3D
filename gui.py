...
def draw_ui(current_w, current_h, delta_w, delta_h, c_w, c_h, sliders, button, mode_name):
    gl.glViewport(0, 0, current_w, current_h)
    gl.glMatrixMode(gl.GL_PROJECTION)
    gl.glPushMatrix()
    gl.glLoadIdentity()
    ...
    draw_text(mode_name, title_x + 60, title_y)
...
class Button:
    ...
    def draw(self, c_h):
        ...
        draw_text(self.label, self.x + self.width*0.3, self.y + self.height*0.2)
